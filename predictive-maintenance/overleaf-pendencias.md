...
- [ ] Entrada `@misc{repo}` do repositório, com o título entre chaves duplas para o `ieeetr` não converter para minúsculas
- [ ] Remoção da entrada `burmeister2023production`
- [ ] Inclusão da entrada `tormos2026hvacxai`
...
- [ ] Parágrafo de escopo restrito a operação contínua de 24 horas, com três exemplos
- [ ] Frase com `\cite{repo}` depois do último parágrafo de trabalhos relacionados, para o repositório sair como `[11]`
- [ ] `\bibliography{refs}` no lugar do `\IfFileExists`
- [ ] Parágrafo do Tormos no lugar do parágrafo do Burmeister

## 3. Compilar duas vezes

- [ ] Clicar em Recompile duas vezes seguidas
...
- [ ] A lista de referências termina com onze entradas
- [ ] O Tormos aparece como `[6]`, entre Gupta e Gubbi
- [ ] O repositório aparece como `[11]`, no fim da lista
- [ ] Não sobrou nenhuma menção a Burmeister nem a IEEE Access

Se ainda aparecer Burmeister, algum dos dois arquivos não foi colado.

## 5. Subir os PDFs para `refsPDF`

- [ ] Tormos et al., 2026 — baixar em <https://www.mdpi.com/1999-4893/19/7/586> (acesso aberto, CC BY 4.0, sem login)
- [ ] Apagar o PDF do Burmeister, se estiver na pasta
- [ ] Os quatro PDFs de contextualização, pendência da AC4
- [ ] Os três PDFs da AC3
