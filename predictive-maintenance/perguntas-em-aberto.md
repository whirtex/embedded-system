...
Tudo que ainda não está decidido no projeto. Enquanto uma pergunta estiver aqui, o
artigo não deve afirmar nada sobre ela.

As decisões já tomadas estão no fim do arquivo, para não serem rediscutidas.

## Decisões do grupo

Sobrou uma, e ela depende de confirmacao com o professor.

1. **Quem faz a instalação no aparelho real, e como.** A caixa elétrica da unidade
...
2. **Frequência de amostragem da vibração.** Precisa cobrir a faixa de interesse do
...
3. **Quanto a corrente sobe** em cada falha induzida, para saber se o sensor escolhido
...
4. **Qual limiar separa normal de anômalo**, e com que margem.

## Já decididas

Registro do que não precisa ser rediscutido.
