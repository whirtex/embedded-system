...
The station does not need a network connection to work. Environmental measurements and entrance images go to a microSD card on the acquisition board, and a real-time clock keeps the timestamps consistent when no external time source is available. The card is retrieved about once a week, and the recorded material is analysed on a separate computer.
